...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form id="form" action="submitTask" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <script type="text/javascript">
                            	function formSubmit(st){
                            		alert("提交内容" + st);
                            		document.getElementById("submitType").value = st;
...
<!--                                <input type="submit"  class="btn btn-primary" value="提   交"/> -->
								<c:forEach items="${list }" var="li">
									<input type="button" onclick="formSubmit('${li}')" class="btn btn-primary" value="${li}"/> 
								</c:forEach>
                            </div>
