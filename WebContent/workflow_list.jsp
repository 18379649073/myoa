                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="dep" items="${depList}">
	                    <tr>
	                        ...
	                        <td>
	                            <a href="${pageContext.request.contextPath }/delDeployment?deploymentId=${dep.id}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>
	                        </td>
	                    </tr>
					</c:forEach>
                    </tbody>
                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="pd" items="${pdList}">
	                    <tr>
	                        ...
	                        <td>
	                          <a target="_self" href="viewImage?deploymentId=${pd.deploymentId}&imageName=${pd.diagramResourceName}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-eye-open"></span> 查看流程定义图</a>
	                        </td>
	                    </tr>
					</c:forEach>
                    </tbody>
